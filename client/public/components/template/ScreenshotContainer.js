        ...
        <div className='scrnShotBox'>   
            ...
            <div className='sliderContainer'>
                <div className='slider'>
                    ...
                    <img className = 'dotIndic' src = {dotIndicator} alt ="" onClick={setImage1}/>
                    <img className = 'dotIndic' src = {dotIndicator} alt ="" onClick={setImage2}/>
                    <img className = 'dotIndic' src = {dotIndicator} alt ="" onClick={setImage3}/>
                    <img className = 'dotIndic' src = {dotIndicator} alt ="" onClick={setImage4}/>
