...
// <form method='post' action="/loginUser" className="authenticationForm">
    return (<SmallContainer title="Log In">
        ...
        <form
            ...
            onSubmit={handleSubmit((data) => {
                axios.post("/loginUser", null, {
                    params: data,
                })
                    .then((res) => {
                        setFlash({
                            class: "success", message: "You have logged in correctly! Redirecting..."
                        })
                    ...
                    .catch((err) => {
                        console.error(err)
                        setFlash({
                            class: "error", message: "Your username or password was incorrect, please try again!"
                        })
                    });
